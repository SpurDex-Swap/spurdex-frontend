...
export const DEFAULT_META: PageMeta = {
  title: 'SpurDex',
  description:
    'The most popular AMM on BSC by user count! Earn SPDX through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by SpurDex), NFTs, and more, on a platform you can trust.',
  image: 'https://spurdex.exchange/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    paths: {
      ...
      '/info': { title: t('Overview'), description: 'View statistics for SpurDex exchanges.' },
      '/info/pools': { title: t('Pools'), description: 'View statistics for SpurDex exchanges.' },
      '/info/tokens': { title: t('Tokens'), description: 'View statistics for SpurDex exchanges.' },
      ...
      '/pancake-squad': { basePath: true, title: t('Spurdex Squad') },
    },
    defaultTitleSuffix: t('SpurDex'),
  }
}
