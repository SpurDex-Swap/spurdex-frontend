import { Token, ChainId } from '@danielvindax/spurdexswap-sdk'
...
const ifos: Ifo[] = [
  ...
  //   },
  //   currency: tokens.spdx,
  //   token: tokens.xrp,
  //   releaseBlockNumber: null,
  //   campaignId: '511190000',
  //   articleUrl: 'https://spurdex.exchange/voting/proposal/QmXwoYYd8rkahVbxiGKsTa4rYRRFWPxhRGAHy3hVwK3Q2z',
