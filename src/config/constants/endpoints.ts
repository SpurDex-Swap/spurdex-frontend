...
export const INFO_CLIENT = 'https://thegraph.spurdex.exchange/subgraphs/name/spurdex/exchange'
export const BLOCKS_CLIENT = 'https://thegraph.spurdex.exchange/subgraphs/name/spurdex/blocks'
export const GRAPH_API_NFTMARKET = process.env.NEXT_PUBLIC_GRAPH_API_NFT_MARKET
export const GRAPH_HEALTH = 'https://thegraph.spurdex.exchange/index-node/graphql'
