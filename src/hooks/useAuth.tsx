...
import { ConnectorNames, connectorLocalStorageKey, Text, Box, LinkExternal } from '@spurdex/uikit'
            ...
            if (error instanceof NoEthereumProviderError || error instanceof NoBscProviderError) {
              toastError(
                ...
                <Box>
                  ...
                  <LinkExternal href="https://docs.spurdex.exchange/get-started/connection-guide">
                    {t('Need help ?')}
                  </LinkExternal>
                </Box>,
              )
