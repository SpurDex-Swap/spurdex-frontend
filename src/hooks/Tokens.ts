...
import { Currency, currencyEquals, ETHER, Token } from '@danielvindax/spurdexswap-sdk'
...
export function useCurrency(currencyId: string | undefined): Currency | Token | null | undefined {
  const isBNB = currencyId?.toUpperCase() === 'CREDIT' || currencyId?.toLowerCase() === GELATO_NATIVE
