import { Box, Message, MessageText } from '@spurdex/uikit'
    ...
    <Message variant="warning">
      <Box>
        <MessageText>
          {notMeetRequired &&
            notMeetThreshold &&
            t('This pool requires active Spurdex Profile and %amount% profile points.', {
              amount: profileRequirement.thresholdPoints.toNumber().toLocaleString(),
            })}
          {notMeetRequired && !notMeetThreshold && t('This pool requires active Spurdex Profile')}
          {!notMeetRequired &&
            notMeetThreshold &&
