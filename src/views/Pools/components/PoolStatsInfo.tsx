import { Button, Flex, Link, LinkExternal, MetamaskIcon, Skeleton, Text, TimerIcon } from '@spurdex/uikit'
...
const PoolStatsInfo: React.FC<ExpandedFooterProps> = ({
  ...
  return (
    <>
      {profileRequirement && (profileRequirement.required || profileRequirement.thresholdPoints.gt(0)) && (
        <Flex mb="8px" justifyContent="space-between">
          ...
          <Text small textAlign="right">
            {profileRequirement.required && t('Spurdex Profile')}{' '}
      ...
      {vaultKey && (
        <Flex mb="2px" justifyContent={alignLinksToRight ? 'flex-end' : 'flex-start'}>
          <LinkExternal href="https://spurdex.exchange/" bold={false} small>
            {t('View Project Site')}
          </LinkExternal>
        </Flex>
      )}
          ...
          <Button
            ...
            onClick={() =>
              registerToken(
                ...
                `https://tokens.spurdex.exchange/images/${tokenAddress}.png`,
              )
            }
          >
