import { Flex, TooltipText, useTooltip } from '@spurdex/uikit'
...
const AprRow: React.FC<AprRowProps> = ({ pool, stakedBalance, performanceFee = 0, showIcon = true }) => {
  ...
  const tooltipContent = vaultKey
    ? t('APY includes compounding, APR doesn’t. This pool’s SPDX is compounded automatically, so we show APY.')
