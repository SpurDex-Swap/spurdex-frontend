...
import { Box, Button, Flex, Heading, LinkExternal } from '@spurdex/uikit'
  ...
  return (
    <>
        ...
        <StyledHeaderInner>
          <div>
            ...
            <Heading scale="lg" color="text">
              {t('Buy and Sell NFTs on CREDIT Smart Chain')}
            </Heading>
            {account && (
      ...
      <Gradient p="64px 0">
        ...
        <LinkExternal href="https://docs.spurdex.exchange/contact-us/nft-market-applications" mx="auto" mt="16px">
