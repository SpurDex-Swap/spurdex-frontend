...
import { AutoRenewIcon, Button, Checkbox, Flex, InjectedModalProps, Text } from '@spurdex/uikit'
...
const PauseProfilePage: React.FC<PauseProfilePageProps> = ({ onDismiss, onSuccess }) => {
  ...
  return (
    <>
      ...
      <Text as="p" color="textSubtle" mb="24px">
        {t('Cost to reactivate in the future: %cost% SPDX', { cost: formatBigNumber(numberCakeToReactivate) })}
      </Text>
