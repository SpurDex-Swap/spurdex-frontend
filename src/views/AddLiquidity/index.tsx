...
import { Currency, currencyEquals, ETHER, TokenAmount, WETH } from '@danielvindax/spurdexswap-sdk'
import { Button, Text, AddIcon, CardBody, Message, useModal, TooltipText, useTooltip } from '@spurdex/uikit'
  ...
  const handleCurrencyBSelect = useCallback(
    (currencyB_: Currency) => {
      ...
      if (currencyIdA === newCurrencyIdB) {
        ...
        router.replace(`/add/${currencyIdA || 'CREDIT'}/${newCurrencyIdB}`, undefined, { shallow: true })
      }
    },
