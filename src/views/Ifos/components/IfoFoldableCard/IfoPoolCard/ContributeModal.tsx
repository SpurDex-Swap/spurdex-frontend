...
const ContributeModal: React.FC<Props> = ({
  ...
  const label = currency === tokens.spdx ? t('Max. SPDX entry') : t('Max. token entry')
      ...
      <ModalBody maxWidth="360px">
        ...
        <Box p="2px">
          ...
          <Text color="textSubtle" fontSize="12px" mb="24px">
            {t(
              'If you don’t commit enough SPDX, you may not receive any IFO tokens at all and will only receive a full refund of your SPDX.',
            )}
            <Link
              fontSize="12px"
              display="inline"
              href="https://docs.spurdex.exchange/products/ifo-initial-farm-offering"
              external
            >
              {t('Read more')}
            </Link>
