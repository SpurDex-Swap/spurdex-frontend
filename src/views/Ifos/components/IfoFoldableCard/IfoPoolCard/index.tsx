...
import { Box, Card, CardBody, CardHeader, Flex, HelpIcon, Text, useTooltip } from '@spurdex/uikit'
...
export const cardConfig = (
  ...
  switch (poolId) {
    case PoolIds.poolBasic:
      if (meta?.version === 3.1) {
        const MSG_MAP = {
          needQualifiedNFT: t('Set PancakeSquad NFT as Spurdex Profile avatar.'),
          needQualifiedPoints: t('Reach a certain Spurdex Profile Points threshold.'),
        }
