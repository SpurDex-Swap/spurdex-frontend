import { Box, Card, CardBody, CardHeader, ExpandableButton, Flex, Text, Message, Button } from '@spurdex/uikit'
      ...
      <CardHeader p="16px">
        ...
        <Flex justifyContent="space-between" alignItems="center">
          <StyledTokenContent alignItems="center" flex={1}>
            <TokenPairImage width={24} height={24} primaryToken={tokens.spdx} secondaryToken={tokens.spdx} />
            <Box ml="8px">
              <Text small bold>
                {t('IFO SPDX')}
              </Text>
          ...
          <StyledCardBody>
            <Message variant="warning" mb="20px">
              <Flex flexDirection="column">
                <Text mb="16px">
                  {t(
                    'This is the old IFO SPDX pool. Check out the brand new SPDX pool to learn how to earn SPDX rewards with higher APY while enjoying other benefits.',
                  )}
                </Text>
                <Flex ml="-34px">
                  <Button onClick={handleOnClick} width="100%">
                    {isShowMigrationButton ? t('Migrate') : t('Go to new SPDX pool')}
                  </Button>
                </Flex>
              </Flex>
            </Message>
            <ActionContainer>
              ...
              <Box mt="24px">
                <Flex alignItems="center" justifyContent="space-between">
                  <Text fontSize="14px">{`${t('Recent SPDX profit')}:`}</Text>
                  <Balance
                    bold
                    fontSize="14px"
