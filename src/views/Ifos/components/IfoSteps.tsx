...
const Step1 = () => {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <Box>
      ...
      <InlineLink
        external
        href="https://medium.com/spurdex/initial-farm-offering-ifo-3-0-ifo-staking-pool-622d8bd356f1"
      >
    ...
    <CardBody>
      ...
      <Box>
        <Text color="textSubtle" small>
          {t(
            'The maximum amount of SPDX user can commit to the Public Sale, is equal to the average SPDX balance in the IFO SPDX pool prior to the IFO. Stake more SPDX to increase the maximum SPDX you can commit to the sale. Missed this IFO? You can keep staking in the IFO SPDX Pool to join the next IFO sale.',
          )}
        </Text>
...
const Step2 = () => {
  ...
  return (
    <CardBody>
      ...
      <Text color="textSubtle" small>
        {t('When the IFO sales are live, you can “commit” your SPDX to buy the tokens being sold.')} <br />
      </Text>
    </CardBody>
  )
}
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active SpurDex Profile to take part in an IFO!')}
            </Text>
            {renderAccountStatus()}
          </CardBody>
        )
      ...
      case 3:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent SPDX tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
