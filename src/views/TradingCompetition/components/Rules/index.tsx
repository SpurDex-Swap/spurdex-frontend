import { Flex, Text } from '@spurdex/uikit'
      ...
      <StyledCardWrapper>
        <RulesCard title={t('Trade to increase your rank')}>
          <Text textAlign="center" fontSize="14px" color="textSubtle">
            {t(
              'Eligible pairs: DAR/CREDIT, SPDX/CREDIT, and SPDX/CUSD. Please note that the volume from limit orders will not be indexed.',
            )}
          </Text>
        </RulesCard>
