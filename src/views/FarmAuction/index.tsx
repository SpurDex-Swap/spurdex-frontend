...
import { Button, Heading, Text, Flex, Link, Breadcrumbs } from '@spurdex/uikit'
        ...
        <Flex flexDirection={['column-reverse', null, 'row']}>
          <Left>
            ...
            <Text color="textSubtle" mb="24px">
              {t('Each week, qualifying projects can bid SPDX for the right to host a 7-day Farm on SpurDex.')}
            </Text>
