...
const config = ({ t }: FAQsType) => [
  ...
  },
  {
    ...
    description: [
      t(
        'Wait for the reveal! After all 10,000 members of the Spurdex Squad have been minted, their images will remain hidden for a few days. Just be patient :)',
      ),
    ],
  },
  {
    ...
    description: [
      ...
      t(
        'Users holding Gen 0 Spurdex Bunny NFTs at the snapshot may also purchase one additional Spurdex Squad NFT in the presale for each Spurdex Bunny they hold.',
      ),
      t(
  ...
  },
  {
    ...
    description: [t('100% of SPDX spent on Spurdex Squad NFTs will be burned as part of our weekly SPDX burn.')],
  },
  {
