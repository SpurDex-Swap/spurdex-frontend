import { Button, Flex, Box, Modal, Text, ChevronRightIcon, InjectedModalProps, Tag, Spinner } from '@spurdex/uikit'
...
export const DetailLimitOrderModal: React.FC<DetailLimitOrderModalProps> = ({ onDismiss, order, formattedOrder }) => {
  ...
  const orderDetails = (
    <>
      ...
      <LimitTradeInfoCard
        currentPriceExchangeRateText="0.002474 CREDIT = 1 CUSD"
        currentPriceExchangeRateTextReversed="404.11169 CUSD = 1 CREDIT"
