import { IconButton, Text, Skeleton, Button, AutoRenewIcon, ChevronRightIcon, Message } from '@spurdex/uikit'
          ...
          <>
            ...
            {total === 0 ? (
              <Message variant="danger" mb="12px">
                <Text color="danger">
                  {t(
                    'Hold some SPDX in your wallet or on SpurDex at the snapshot block to get voting power for future proposals.',
                  )}
                </Text>
              </Message>
            ) : (
