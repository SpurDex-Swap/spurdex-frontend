...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from '@spurdex/uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'SPDX card' },
    { src: 'green', alt: 'Green SPDX card with up arrow' },
    { src: 'red', alt: 'Red Spdx card with down arrow' },
    { src: 'top-right', alt: 'SPDX card' },
  ],
}
