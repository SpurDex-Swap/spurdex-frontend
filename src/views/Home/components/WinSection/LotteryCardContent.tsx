...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from '@spurdex/uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in SPDX prizes this round', { cakePrizeInUsd: cakePriceBusd.toString() })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with SPDX, win SPDX if your numbers match')}
        </Text>
      </Flex>
