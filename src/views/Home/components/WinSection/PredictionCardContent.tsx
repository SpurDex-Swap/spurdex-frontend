...
import { ArrowForwardIcon, Button, Flex, Heading, Skeleton, Text } from '@spurdex/uikit'
...
const PredictionCardContent = () => {
  ...
  const bnbWonText = t('$%bnbWonInUsd% in CREDIT won so far', { bnbWonInUsd: '#placeholder#' })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="#280D5F" mb="40px">
          {t('Will CREDIT price rise or fall? guess correctly to win!')}
        </Text>
      </Flex>
