import { ArrowForwardIcon, Button, Text, Link, useMatchBreakpointsContext } from '@spurdex/uikit'
...
const PerpetualBanner = () => {
  ...
  const perpetualUrl = useMemo(() => `https://perp.spurdex.exchange/${perpLangMap(code)}/futures/BTCUSDT`, [code])
