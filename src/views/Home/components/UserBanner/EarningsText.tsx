...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SPDX pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SPDX pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SPDX pool', data)
  }
