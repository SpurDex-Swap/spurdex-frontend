...
const whitelist = [
  ...
  `Don't let that dopey smile deceive you... Churro's a master SPDX chef!`,
  `Nommm... Oh hi, I'm just meditating on the meaning of SPDX.`,
  `Three guesses what's put that twinkle in those eyes! (Hint: it's SPDX)`,
...
describe('Check translations available', () => {
  ...
  throughDirectory('node_modules/@spurdex/uikit', true)
