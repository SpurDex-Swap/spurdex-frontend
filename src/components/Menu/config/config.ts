...
import { DropdownMenuItems } from '@spurdex/uikit/src/components/DropdownMenu/types'
...
const config: (t: ContextApi['t'], languageCode?: string) => ConfigMenuItemsType[] = (t, 
  ...
  ) => [
  {
    ...
    items: [
      ...
      // {
      //   label: t('Perpetual'),
      //   href: `https://perp.spurdex.exchange/${perpLangMap(languageCode)}/futures/BTCUSDT`,
