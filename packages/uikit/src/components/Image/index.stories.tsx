...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://spurdex.exchange/images/tokens/${token.address[13308]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://spurdex.exchange/images/tokens/${token.address[13308]}.png`;
        const secondarySrc = `https://spurdex.exchange/images/tokens/${tokens[randomTokenIndex].address[13308]}.png`;
